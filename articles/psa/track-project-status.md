...
| **Цінова пропозиція** |  Коли проект пов'язується з ціновою пропозицією або створюється з цінової пропозиції, на етапі проекту встановлено значення **Цінова пропозиція**, а приблизні дати початку та завершення також оновлюються. Коли проект знаходиться в стадії цінової пропозиції, відомості на дисплеї цінової пропозиції на вкладці **Sales** на сторінці **Проект**. |
