...
description: У цій статті наведено посилання на відомості про базові цінові пропозиції, ціноутворення та виставлення рахунків у Project Service Automation.
author: kfend
ms.custom:
