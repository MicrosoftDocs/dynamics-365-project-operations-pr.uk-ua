...
description: У цій статті наведено відомості про використання категорії транзакції як цінового виміру.
author: Rumant
ms.custom:
...
У цій статті показано, як використовувати категорію транзакції як ціновий параметр. Перш ніж почати, якщо рішення критерію ціноутворення ще не було створено, потрібно створити нове. Якщо рішення з критерієм ціноутворення вже є, можна внести зміни в це рішення. Якщо ви не створили нове рішення для параметрів ціноутворення для вашої організації, виконайте процедури, описані в [статті Створення настроюваних полів і сутностей](create-custom-fields-entities.md).
