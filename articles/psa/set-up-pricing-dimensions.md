...
description: У цій статті наведено відомості про настроювання настроюваних параметрів ціноутворення.
author: Rumant
ms.custom:
