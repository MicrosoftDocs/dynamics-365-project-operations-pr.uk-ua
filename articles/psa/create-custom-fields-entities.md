...
description: У цій статті пояснюється, як створювати набори параметрів і сутності у власному рішенні на платформі Power Apps.
author: Rumant
ms.custom:
...
Процедури в цій статті повинні бути завершені за допомогою веб-інтерфейсу автоматизації обслуговування проектів (PSA).
