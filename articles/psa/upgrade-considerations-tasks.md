...
description: У цій статті наведено відомості про оновлення структури розбивки роботи з автоматизації служби project 2.x до 3.x.
ms.custom:
