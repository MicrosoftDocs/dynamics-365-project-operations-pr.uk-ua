...
Наприклад, компанія Contoso US продала 100 футболок клієнту у Сполученому Королівстві за ціною 15 фунтів стерлінгів (GBP) одна футболка. У наведеній нижче таблиці показано, як буде записано цю транзакцію в сутності «Замовлення продукту».
...
Цей розділ присвячено опису прикладу проекту, який компанія Contoso Сполучене Королівство виконує для клієнта в Японії під назвою Fabrikam. Ось як сценарій був налаштований:
...
3. Налаштовано організаційну одиницю під назвою **Contoso Сполучене Королівство**, для якої вибрано валюту британські фунти стерлінгів.
4. Створено сервісний договір проекту, за яким **Contoso Сполучене Королівство** вибрано в якості підрозділу, який відповідає за залучення клієнтів, а компанію **Fabrikam – Японія** в якості клієнта.
...
6. Створено сервісний договір проекту, за яким **Contoso Сполучене Королівство** визначено в якості підрозділу, який відповідає за залучення клієнтів. Цей проект створюється і зіставляється з сервісною роботою по договору проекту.
