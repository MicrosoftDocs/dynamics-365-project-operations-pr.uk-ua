...
description: У цій статті наведено відомості про додавання настроюваних полів до цінових параметрів і транзакційних сутностей.
author: Rumant
ms.custom:
...
У цій статті передбачається, що ви завершили процедури, описані в статті [Створення настроюваних полів і сутностей](create-custom-fields-entities.md). Якщо ви ще не виконали ці процедури, поверніться назад і завершіть їх, а потім поверніться до цієї статті. 
