...
description: У цій статті наведено відомості про додавання настроюваних полів до настройок ціни та транзакційних сутностей.
author: Rumant
ms.custom:
...
У цій статті припускається, що ви виконали процедури, описані в статті, [Створити настроювані поля та сутності](create-custom-fields-entities.md). Якщо ви ще не виконали ці процедури, поверніться назад і завершіть їх, а потім поверніться до цієї статті. 
...
1. У Project Service Automation (PSA) клацніть **Налаштування** > **Рішення**, а потім двічі клацніть **критерії ціноутворення \<your organization name>**. 
...
6. Повторіть кроки 1-5, щоб додати це поле до сутностей **Відомостей про сервісну роботу за договором**, **Проектне завдання**, **Учасник робочої групи проекту** та **Позиція прогнозу**.
...
5. Повторіть кроки 1-5, щоб створити зв'язок 1:N із **Стандартної посади** до **Відомостей про позицію цінової пропозиції**, **Відомостей про сервісну роботу за договором**, **Проектне завдання**, **Учасник робочої групи проекту** та **Позиція прогнозу**.
