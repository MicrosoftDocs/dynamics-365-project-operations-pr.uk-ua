...
description: У цій статті викладається інформація про відстеження виконання проекту та витрачання коштів.
author: ruhercul
ms.custom:
...
Необхідність відстежувати перебіг виконання за розкладом залежить від галузей. Деякі галузі відстежують на дуже детальному рівні, тоді як інші галузі відстежують вищому рівні. У цій статті показано, як виконати планування, щоб задовольнити вимоги організації.
