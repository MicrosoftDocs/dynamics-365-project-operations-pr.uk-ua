...
description: У цій статті наведено відомості про те, що нового в project служби автоматизації оновлення реліз 12, V3.
author: ruhercul
...
У цій статті перелічено функції та виправлення, які є новими або зміненими для автоматизації служби project V3, оновлення випуску 12. Ця версія має номер збірки V3.10.2.34 та зазвичай надається в складі оновлення за жовтень 2019 р., яке можна завантажити самостійно.
