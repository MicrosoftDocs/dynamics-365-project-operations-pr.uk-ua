...
description: У цій статті пояснюється, як адміністратор може внести одноразові або масові виправлення до раніше затверджених записів часу або витрат, якщо виставлення рахунків не завершено.
author: rumant
ms.date: 04/02/2020
ms.topic: article
...
Щоб виконати процедури, описані в цій статті, вам знадобляться дозволи адміністратора.
