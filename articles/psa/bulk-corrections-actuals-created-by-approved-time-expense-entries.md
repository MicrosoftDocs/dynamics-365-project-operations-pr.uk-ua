...
description: У цій статті пояснюється, як адміністратор може робити одноразові або пакетні виправлення до раніше затверджених записів часу або витрат, якщо виставлення рахунка не завершено.
author: rumant
ms.date: 04/02/2020
ms.topic: article
...
Для виконання процедур, описаних у цій статті, потрібні дозволи адміністратора.
