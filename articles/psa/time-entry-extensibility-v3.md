...
description: У цій статті наведено відомості про впровадження настроюваних бізнес-правил, які підтримують практику організації.
author: stsporen
ms.custom:
...
У розділі **Критерії** не можна використовувати вбудоване редагування. Цей розділ спирається на подання, яке дає змогу додавати настроювані поля до тижневої сітки запису часу. Для отримання відомостей про додавання настроюваних полів див.
