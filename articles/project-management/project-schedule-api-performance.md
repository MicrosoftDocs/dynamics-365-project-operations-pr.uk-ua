...
description: У цій статті наведено інформацію про опорні позначки продуктивності API планування проектів та описано рекомендації для оптимального використання.
author: ruhercul
ms.date: 11/03/2021
ms.topic: article
...
У цій статті наведено інформацію про опорні позначки продуктивності прикладних програмних інтерфейсів (API) планування проектів та описано рекомендації для оптимізації використання.
...
API планування проектів використовують в роботі службу планування проектів для виконання запитів, описаних у подальших розділах цієї статті.
