...
description: У цій статті наведено відомості про те, як відстежувати обсяг і перебіг робіт за проектом.
author: ruhercul
ms.date: 02/15/2022
ms.topic: overview
...
Необхідність відстежувати перебіг виконання за розкладом залежить від галузей. Деякі галузі відстежують виконання на дуже детальному рівні, тоді як інші галузі відстежують більш загальному рівні. У цій статті показано, як виконати планування, щоб задовольнити вимоги організації.
...
- Затверджений обсяг роботи над зведеним завданням — це сума затвердженого обсягу роботи над всіма дочірніми завданнями плюс затверджений обсяг робіт над зведеним завданням.
- Залишок обсягу роботи над зведеним завданням — це сума залишку обсягу роботи над всіма дочірніми завданнями мінус затверджений обсяг робіт над зведеним завданням.
