...
description: У цьому розділі наведено відомості та зразки, які допоможуть вам використовувати журнали планування проектів для відстеження помилок, пов'язаних із службою планування проекту та API планування проектів.
author: ruhercul
ms.date: 11/30/2021
ms.topic: article
