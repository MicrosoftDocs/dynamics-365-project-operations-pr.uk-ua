...
description: У цій статті наведено відомості про етапи проекту, доступні в Microsoft Dynamics розділі Операції з проектом.
author: ruhercul
ms.date: 09/18/2020
ms.topic: article
ms.prod: ''
...
Коли ви виграєте цінову пропозицію, пов'язану із проектом, проект переходить до стадії **Сервісний договір**, а проект оновлюється до стадії **План**. Поки проект знаходиться на **стадії планування**, на **вкладці Продажі** на **сторінці «Суть проекту»** відображаються відомості про контракт.
