...
description: У цій статті наводиться інформація про те, як програма Project Operations відстежує прогрес проекту відносно доходу від робочої сили за проектом.
author: rumant
ms.date: 03/24/2021
ms.topic: article
