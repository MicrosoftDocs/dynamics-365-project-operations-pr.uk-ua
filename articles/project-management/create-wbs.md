...
Атрибути персоналу доступні в полі **Ресурси** у розкладі. Можна або знайти наявний ресурс, або натиснути кнопку **Створити** та в області **Швидке створення**, додати учасника робочої групи як новий ресурс.  Під час пошуку ресурсу за допомогою вибору ресурсів у сітці завдань, поданні дошки або ганта пошук повертає наявних членів групи проекту або активні ресурси, які можна забронювати.
...
| Максимальна загальна кількість ресурсів для проекту              | 150                  |
...
| Максимальна кількість елементів контрольного списку для одного завдання                   | 20                   |
