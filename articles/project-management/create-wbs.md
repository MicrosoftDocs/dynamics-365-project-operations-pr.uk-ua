...
description: У цій статті пояснюється, як створити ієрархічну структуру робіт (WBS), що включає основні елементи керування в новому інтерфейсі планування.
author: ruhercul
ms.date: 12/16/2021
ms.topic: article
...
Завдання можуть бути переміщені на будь-який рівень в ієрархічній структурі робіт одним з двох способів:
...
Поля **Роль**, **Одиниця ресурсів** та **Назва посади** використовуються для опису вимог до ресурсів для певного завдання. Ці атрибути персоналу разом із розкладом завдань використовуються для пошуку доступних ресурсів для виконання цього завдання.
   ...
   - **Роль**: укажіть тип ресурсу, необхідного для виконання завдання.,
...
## <a name="understanding-the-impacts-of-duration-resource-calendars-and-project-calendars-on-tasks"></a>Розуміння впливу тривалості, календарів ресурсів і календарів проектів на завдання
Тривалість завдання визначається як кількість робочих годин між часом початку дати початку та часом завершення дати завершення завдання.   Проект для Інтернету визначає одиниці вимірювання тривалості наступним чином:

| **Міра тривалості** | **Кількість**|
|----------------------------------------------------|----------------------|
| Годин на день | 8 |
| Годин на тиждень |  40 |
| Днів на місяць |  20 |

Непризначені завдання плануються за допомогою календаря проекту. Однак після початкового призначення ресурсу планування завдання оновлюється таким чином, щоб воно відповідало календарю ресурсу. Подальші зміни завдання, яке має призначення, регулюватимуться режимом [планування](scheduling-modes.md) проекту. Щоб дізнатися більше про вплив календарів на завдання, перегляньте [статті Календарі ресурсів у веб-програмі Project для Інтернету](https://techcommunity.microsoft.com/t5/project-blog/resource-calendars-in-project-for-the-web/ba-p/3269686) та [Час початку завдань і Ваші проекти!](https://techcommunity.microsoft.com/t5/project-blog/task-start-times-amp-your-projects/ba-p/3269665)
...
| Максимальна кількість елементів контрольного списку для кожного завдання                   | 20                   |
