...
2. Якщо до запису рахунку прив'язані прайс-листи проекту, система переглядає торгові прайс-листи, прикріплені до параметрів проекту, які відповідають валюті котирування проекту.
