...
description: У цій статті наведено відомості про додавання необхідних посилань на настроювані поля до сутностей, а також до форм і подань.
author: rumant
ms.date: 09/18/2020
ms.topic: article
ms.prod: ''
...
У цій статті передбачається, що ви завершили процедури в статті [Створення настроюваних полів і сутностей, що використовуватимуться, як критерії визначення цін](create-custom-fields-entities-pricing-dimensions.md). Якщо ви ще не виконали ці процедури, поверніться назад і завершіть їх, а потім поверніться до цієї статті. 

У цій статті процедура покаже, як додати потрібні настроювані поля до сутностей і елементів інтерфейсу користувача, наприклад форм та подань.
