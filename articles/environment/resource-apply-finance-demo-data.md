...
description: У цій статті пояснюється, як застосовувати демонстраційні дані з Project Operations до хмарного середовища Dynamics 365 Finance.
author: sigitac
ms.date: 10/01/2020
ms.topic: article
...
> [!IMPORTANT]
> Ця стаття застосовується виключно до Microsoft Dynamics 365 Finance версії 10.0.13, а рекомендації цієї теми можуть виконуватися тільки в хмарному середовищі. Виконайте кроки з цієї статті, **ПЕРШ НІЖ** застосовувати покращення до середовища.
...
![Програми для фінансів і операцій.](./media/10FinanceAndOperations.png)
