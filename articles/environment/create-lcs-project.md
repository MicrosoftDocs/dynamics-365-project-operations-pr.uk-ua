...
description: У цій статті наведено відомості про створення нового проекту в службі LCS для операційного середовища проекту.
author: stsporen
ms.date: 10/01/2020
ms.topic: article
...
5. Назвіть проект. 
6. Виберіть **фінанси та операції** як назву продукту, а також виберіть галузь і методологію. 
7. Виберіть **Створити**.
