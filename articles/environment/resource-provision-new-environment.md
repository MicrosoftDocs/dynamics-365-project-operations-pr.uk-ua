...
2. У списку **Підготовча функція** виберіть **Project Operations** і виберіть **Підготовчу функцію ввімкнуто**, щоб увімкнути Project Operations.
...
| **Сутність інтеграції Project Operations для оцінки часу (msdyn\_resourceassignments)** | No | No | Н/Д | No | Н/Д |
...
5. Продовжуйте запуск зіставлення після завершення оновлення.

![Оновлення зіставлення](./media/20RefreshMapping.png)

Перш ніж вмикати наступне зіставлення, переконайтеся, що зіставлення в таблиці перебуває в стані **Виконується**. Запуск зіставлень із більшою кількістю необхідних компонентів може тривати певний час.
