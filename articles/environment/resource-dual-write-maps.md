...
description: Ця стаття список необхідних для Dynamics 365 Project Operations зіставлень з подвійним записуванням.
author: sigitac
ms.date: 07/01/2021
ms.topic: article
...
| --- | --- |
| Леджер (msdyn_ledgers) | Необхідна початкова синхронізація зіставлення таблиці та всіх необхідних компонентів. Основні програми для початкової синхронізації, це програми для фінансів і операцій. |
...
1. У списку зіставлень виберіть зіставлення "Книга" **(msdyn\_ledgers)** з усіма необхідними компонентами та встановіть прапорець **Початкова синхронізація**. У полі **Основний для початкової синхронізації** виберіть **Програми для фінансів і операцій** для зіставлення книги та всіх необхідних зіставлень. Виберіть **Запустити**.
...
| Таблиця інтеграції проекту для матеріальних кошторисів (msdyn\_estimatelines) | 1.0.0.0 | Не обов'язково для підготовки. ||
| Пропозиціями рахунків проекту V2 (рахунки-фактури) | 1.0.0.3 | Не обов'язково для підготовки. ||
| Фактичні дані про інтеграцію Project Operations (msdyn_actuals) | 1.0.0.15 | Не обов'язково для підготовки. |10.0.29 або пізнішої версії|
...
| Сутність Project Operations для інтеграції експорту рахунку постачальника проекту (msdyn_projectvendorinvoices) | 1.0.0.2 | Не обов'язково для підготовки. |10.0.29 або пізнішої версії|
| Сутність Project Operations для інтеграції експорту позиції рахунку постачальника проекту (msdyn_projectvendorinvoicelines) | 1.0.0.5 | Не обов'язково для підготовки. | 10.0.29 або пізнішої версії |
