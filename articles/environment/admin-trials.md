...
description: У цій статті наведено відомості про розгортання ознайомлювальної версії Dynamics 365 Project Operations.
author: ruhercul
ms.date: 01/10/2022
ms.topic: article
...
У цій статті описано, як підписатися на партнерську пропозицію підготовчої версії та розгорнути середовище Dynamics 365 Project Operations.

Завдяки новій ознайомлювальній версії Project Operations можна автоматично розгортати будь-який із трьох підтримуваних сценаріїв розгортання, заповнивши анкету, яка порекомендує найкращий спосіб розгортання. У цій статті наведено такі відомості:
...
4.  Виберіть відповідну URL-адресу Microsoft Dataverse і URL-адреси програм для фінансів і операцій для підтвердження розгортання.

## <a name="configuring-dual-write"></a>Налаштування подвійного записування
- Щоб налаштувати ролі безпеки для подвійного записування, див. статтю [Оновлення параметрів безпеки для Project Operations у Dataverse](resource-provision-new-environment.md#update-security-settings-on-project-operations-on-dataverse).
- Щоб відкрити конфігурацію подвійного запису, перейдіть до екземпляра програми для фінансів і операцій, а потім перейдіть до розділу **Керування даними** > **Подвійне записування**.
- Щоб налаштувати зіставлення з подвійним записуванням, див. розділ [Виконання зіставлення з подвійним записуванням в Project Operations](resource-provision-new-environment.md#run-project-operations-dual-write-maps).
...
### <a name="what-if-i-require-alm-or-elm-for-my-finance-and-operations-apps-environment"></a>Що робити, якщо для мого середовища програм для фінансів і операцій потрібні ALM або ELM?
