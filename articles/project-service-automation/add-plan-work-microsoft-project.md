...
## <a name="upload-a-project-file-to-sharepoint-or-office-groups"></a>Завантажте файл проекту на SharePoint або Office Groups  
 Ви можете завантажити файл проекту до SharePoint і знайти його у "Пов'язаних документах" для вашого проекту [!INCLUDE[pn_project_service_auto](../includes/pn-project-service-auto.md)].  Ваш адміністратор має налаштувати керування документами SharePoint і ввімкнути його для сутності Project. [!INCLUDE[proc_more_information](../includes/proc-more-information.md)] [Настройте інтеграцію з SharePoint](../admin/set-up-sharepoint-integration.md)  

 Ви також можете завантажити файл свого Проекту до [!INCLUDE[pn_onedrive_for_business](../includes/pn-onedrive-for-business.md)], якщо у вас встановлено Office Groups. [!INCLUDE[proc_more_information](../includes/proc-more-information.md)] [Співпраця з колегами за допомогою Груп Office 365](../basics/collaborate-with-colleagues-using-office-365-groups.md)  
