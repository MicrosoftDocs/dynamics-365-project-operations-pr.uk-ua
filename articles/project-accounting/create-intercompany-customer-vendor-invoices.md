...
description: У цій статті надається інформація про те, як створювати внутрішні рахунки клієнта та постачальника.
author: sigitac
ms.date: 04/12/2021
ms.topic: article
...
1. У програмі Dynamics 365 Finance відкрийте меню **Керування проектом і бухгалтерський облік** > **Рахунки проекту** > **Внутрішні рахунки клієнта**. На сторінці списку **Внутрішні рахунки клієнта** на панелі дій натисніть **Створити**.
