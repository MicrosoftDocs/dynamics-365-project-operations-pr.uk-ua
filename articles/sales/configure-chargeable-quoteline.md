...
description: У цій статті наведено відомості про включені, платні та неоплачувані компоненти на лініях цінових пропозицій на основі проекту.
author: rumant
ms.date: 11/18/2020
ms.topic: article
