---
title: Керування потенційними клієнтами на основі проектів
description: У цій статті наведено відомості про керування потенційними клієнтами на основі проектів.
author: rumant
ms.date: 10/01/2020
ms.topic: article
...
ms.locfileid: "9825825"
---
# <a name="manage-project-based-leads"></a>Керування потенційними клієнтами на основі проектів
...
## <a name="create-a-new-project-based-lead"></a>Створення нового потенційного клієнта на основі проекту 
