---
title: Графіки рахунків-фактур у рядках цінових пропозицій проекту
description: У цій статті наведено відомості про створення розкладів виставлення рахунків та проміжних етапів для позицій цінових пропозицій.
author: rumant
ms.date: 10/01/2020
ms.topic: article
...
## <a name="create-a-time-and-material-invoice-schedule-for-a-project-quote-line"></a>Створення графіка рахунка-фактури за часом і матеріалами для рядка цінової пропозиції проекту
...
## <a name="create-a-fixed-price-invoice-schedule-for-a-project-quote-line"></a>Створення графіка рахунка-фактури з фіксованою ціною для рядка цінової пропозиції проекту
