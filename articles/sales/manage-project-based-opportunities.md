...
Потенційні угоди на основі проектів у Dynamics 365 Project Operations розроблені з урахуванням розширення до Dynamics 365 Sales. У статті наведено докладні відомості про різні галузі та бізнес-логіку, включені в додаткову функціональність, яка потрібна проектним компаніям для управління проектними можливостями.
