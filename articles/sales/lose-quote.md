---
title: Копіювання цінових пропозицій проекту
description: У цій статті наведено відомості про те, як копіювати котирування проектів в операціях проекту.
author: rumant
ms.date: 10/01/2020
ms.topic: article
...
ms.locfileid: "9825332"
---
# <a name="copy-project-quotes"></a>Копіювання цінових пропозицій проекту
