...
description: У цій статті пояснюється, як використовувати цінові розміри для підтримки оцінки цін і витрат для ресурсу, який заповнює кілька ролей у проекті.
author: rumant
ms.date: 11/16/2020
ms.topic: article
