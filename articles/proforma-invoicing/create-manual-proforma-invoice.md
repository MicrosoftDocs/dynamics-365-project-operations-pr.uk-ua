...
description: У цій статті наводиться інформація про попередні рахунки в Project Operations.
author: rumant
ms.date: 04/05/2021
ms.topic: article
ms.prod: ''
...
> [!NOTE]
> Підтверджені рахунки-проформи та пов’язані записи, наприклад позиції рахунків і відомості позицій рахунків, не можна редагувати або видаляти. 
