...
description: У цій статті наведено відомості про різні подання, доступні для використання під час керування відставанням від виставлення рахунків за проектами.
author: rumant
ms.date: 10/26/2020
ms.topic: article
