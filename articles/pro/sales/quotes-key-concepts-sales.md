---
title: Концепції, що є унікальними для цінових пропозицій проекту
...
- Котирування продажів дозволяють прикріпити кілька замовлень до котирування продажу. Під час операцій проекту до котирування проекту можна додати лише один контракт проекту.
...
- Котирування продажу не містить деяких полів і концепцій, включених до котирування проекту. Поля включають **Договірну одиницю**, **Диспетчер облікових записів** і **Рахунок на ім'я контактної особи**.  
