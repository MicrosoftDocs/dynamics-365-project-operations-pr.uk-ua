---
title: Відомості про заголовок для потенційних угод проекту
description: У цій статті наведено відомості про операції та рядки потенційних угод на основі проектів.
author: rumant
ms.date: 10/01/2020
ms.topic: article
