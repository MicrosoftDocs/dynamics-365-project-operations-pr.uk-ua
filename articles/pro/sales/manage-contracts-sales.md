...
description: У цій статті наводяться відомості про перегляд сервісних договорів на основі проекту.
author: rumant
ms.date: 10/26/2020
ms.topic: article
...
> [!NOTE]
> Не можна видаляти сервісні договори, які мають проекти, завдання, прогнози, журнали та/або фактичні дані, пов’язані з ними. 
