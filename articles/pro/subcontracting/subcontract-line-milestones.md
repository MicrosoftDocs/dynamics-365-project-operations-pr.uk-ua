...
description: У цій статті описано, як створювати та підтримувати розклад рахунків на основі проміжних етапів для підрядного сервісного договору з постачальником.
author: rumant
ms.date: 09/14/2022
ms.topic: article
