...
description: У цій статті описано, як налаштувати та підтримувати ресурси субпідрядника, створені з користувачів та контактних осіб у системі, щоб їх можна було пов’язати із субпідрядними сервісними договорами в Microsoft Dynamics 365 Project Operations.
author: rumant
ms.date: 09/14/2022
ms.topic: article
