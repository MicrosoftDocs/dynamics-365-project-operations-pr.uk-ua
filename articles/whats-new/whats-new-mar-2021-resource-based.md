...
description: У цій статті наведено відомості про оновлення якості, доступні в березні 2021 року випуску «Операції проекту» для сценаріїв на основі ресурсів або без запасів.
author: sigitac
ms.date: 03/03/2021
ms.topic: article
ms.prod: ''
...
- Управління проектами та облік на Dynamics 365 Finance середовищі версії 10.0.16 
