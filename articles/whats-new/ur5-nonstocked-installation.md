...
description: У цій статті наведено відомості про оновлення Project Operations у вашому середовищі Dynamics 365 Finance.
author: ruhercul
ms.date: 12/11/2020
ms.topic: article
ms.prod: ''
...
У цій статті наведено відомості про оновлення Dynamics 365 Project Operations у вашому середовищі Dynamics 365 Finance. Для оновлення Project Operations до Update 5 (UR5) існує три необхідні процедури.
...
7. У полі **Основний для початкової синхронізації** натисніть **Програми для фінансів і операцій** і потім виберіть **Запустити**.
