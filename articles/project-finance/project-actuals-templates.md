...
- Якщо ви створюєте новий шаблон, ви маєте додати стовпець для внутрішнього часу та витрат. Виберіть **Додати умовний стовпець** і введіть ім’я стовпця, наприклад **Юридична особа**. Введіть умову для стовпця, де: якщо **msdyn\_contractorganizationalunitid.msdyn\_name** є \<організаційна одиниця\>, тоді \<введіть юридичну особу\>; в іншому разі null-значення.
...
[![Зіставлення шаблону](./media/ActualsMapping.jpg)](./media/ActualsMapping.jpg)

[![Зіставлення шаблону](./media/TransactionConnections.jpg)](./media/TransactionConnections.jpg)
...
[![Зіставлення шаблону](./media/ActualsUpdateMapping.jpg)](./media/ActualsUpdateMapping.jpg)

[![Зіставлення шаблону](./media/TransactionConnectionsUpdate.jpg)](./media/TransactionConnectionsUpdate.jpg)
