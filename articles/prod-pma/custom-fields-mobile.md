...
description: У цій статті наведено загальні шаблони для використання розширень для реалізації настроюваних полів.
author: Yowelle
ms.date: 05/29/2019
ms.topic: article
ms.prod: ''
...
У цій статті наведено загальні шаблони для використання розширень для реалізації настроюваних полів. Розглянуто зазначені нижче статті.
...
Ця стаття призначена для розробників, які інтегрують настроювані поля в програму для мобільних пристроїв Microsoft Dynamics 365 Project Timesheet, доступну для Apple iOS і Google Android. У цьому розділі припускається, що читачі знайомі з розробкою X++ і функціональністю табелю проекту.
