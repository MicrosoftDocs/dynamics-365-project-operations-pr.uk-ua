...
description: У цьому розділі описано шаблони та основні завдання, які використовуються для синхронізації оцінок годин проекту та оцінки витрат проекту безпосередньо від Microsoft Dynamics 365 Project Service Automation Dynamics 365 Finance.
author: Yowelle
ms.date: 07/20/2018
ms.topic: article
ms.prod: ''
...
У цьому розділі описано шаблони та основні завдання, які використовуються для синхронізації оцінок годин проекту та оцінки витрат проекту безпосередньо від Dynamics 365 Project Service Automation Dynamics 365 Finance.
