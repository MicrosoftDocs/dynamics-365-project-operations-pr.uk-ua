---
title: Синхронізація кошторисів проекту безпосередньо від автоматизації служби проекту до фінансів та операцій
description: У цій статті описано шаблони та основні завдання, які використовуються для синхронізації кошторисів годин проекту та кошторисів витрат проекту безпосередньо з Microsoft Dynamics 365 Project Service Automation Dynamics 365 Finance.
author: Yowelle
ms.date: 07/20/2018
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9029830"
---
# <a name="synchronize-project-estimates-directly-from-project-service-automation-to-finance-and-operations"></a>Синхронізація кошторисів проекту безпосередньо від автоматизації служби проекту до фінансів та операцій

[!include[banner](../includes/banner.md)]

У цій статті описано шаблони та основні завдання, які використовуються для синхронізації кошторисів годин проекту та кошторисів витрат проекту безпосередньо з Dynamics 365 Project Service Automation Dynamics 365 Finance.
...
У шаблоні оцінки годин проекту для виконання таких завдань потрібно використовувати програму Microsoft Power Query для Excel.
...
- Необхідно додати цей стовпець, якщо ви створюєте новий шаблон. В Power Query, виберіть Додати **умовний стовпець** і введіть ім'я нового стовпця, наприклад **ModelID**. Введіть умову для стовпця, де, якщо завдання проекту не є null-значенням, тоді \<enter the forecast model ID\>; в іншому разі null-значення.
...
У шаблоні кошторису витрат проекту необхідно використовувати Power Query для виконання наступних завдань:
...
- Якщо використовується шаблон обчислення витрат за промовчанням (psa to Fin і Ops), у Power Query розділі "Застосовані кроки **" виберіть першу** умову **вставлення**. У записі **Функція** замініть **O\_forecast** назвою ідентифікатора моделі прогнозу, яку слід використовувати з цією інтеграцією. У шаблоні за замовчуванням є ідентифікатор моделі прогнозу, взятий із демонстраційних даних.
- Необхідно додати цей стовпець, якщо ви створюєте новий шаблон. В Power Query, виберіть Додати **умовний стовпець** і введіть ім'я нового стовпця, наприклад **ModelID**. Введіть умову для стовпця, де, якщо ідентифікатор рядка кошторису не є null-значенням, тоді \<enter the forecast model ID\>; в іншому разі null-значення.
