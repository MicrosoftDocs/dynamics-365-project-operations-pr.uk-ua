---
title: Синхронізація оцінок проекту безпосередньо від автоматизації служб проекту до фінансів та операцій
description: У цій статті описано шаблони та основні завдання, які використовуються для синхронізації оцінок годин проекту та оцінки витрат на проект безпосередньо від Microsoft Dynamics 365 Project Service Automation Dynamics 365 Finance до Dynamics 365 Finance.
author: Yowelle
ms.date: 07/20/2018
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8920867"
---
# <a name="synchronize-project-estimates-directly-from-project-service-automation-to-finance-and-operations"></a>Синхронізація оцінок проекту безпосередньо від автоматизації служб проекту до фінансів та операцій

[!include[banner](../includes/banner.md)]

У цій статті описано шаблони та основні завдання, які використовуються для синхронізації оцінок годин проекту та оцінки витрат на проект безпосередньо від Dynamics 365 Project Service Automation Dynamics 365 Finance до Dynamics 365 Finance.
...
У шаблоні оцінки години проекту потрібно використовувати Microsoft Power Query для Excel для виконання таких завдань:
...
- Необхідно додати цей стовпець, якщо ви створюєте новий шаблон. У Power Query програмі виберіть пункт **Додати умовний стовпець** і введіть ім'я нового стовпця, наприклад **ModelID**. Введіть умову для стовпця, де, якщо завдання проекту не є null-значенням, тоді \<enter the forecast model ID\>; в іншому разі null-значення.
...
У шаблоні оцінки витрат проекту потрібно виконати Power Query такі завдання:
...
- Якщо використовується шаблон оцінки витрат проекту за промовчанням (PSA для Fin and Ops), у Power Query програмі виберіть першу **вставлену умову** **в розділі Застосовані кроки**. У записі **Функція** замініть **O\_forecast** назвою ідентифікатора моделі прогнозу, яку слід використовувати з цією інтеграцією. У шаблоні за замовчуванням є ідентифікатор моделі прогнозу, взятий із демонстраційних даних.
