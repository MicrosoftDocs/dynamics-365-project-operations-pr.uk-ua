...
description: У цій статті пояснюється, як налаштувати стандартні витрати на оплату праці та витрати на проект.
author: Yowelle
ms.date: 08/02/2019
...
У цій статті пояснюється, як налаштувати стандартні витрати на оплату праці та витрати на проект. У цьому завданні використовується набір даних USSI.
