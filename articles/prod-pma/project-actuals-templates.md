---
title: Синхронізація фактичних даних проекту безпосередньо з автоматизації служби проекту до журналу інтеграції проекту для публікації у фінансах та операціях
description: У цій статті описано шаблони та основні завдання, які використовуються для синхронізації фактичних трудовитрат проекту безпосередньо з Microsoft Dynamics 365 Project Service Automation фінансів і операцій.
author: Yowelle
ms.date: 07/20/2018
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9029003"
---
# <a name="synchronize-project-actuals-directly-from-project-service-automation-to-the-project-integration-journal-for-posting-in-finance-and-operations"></a>Синхронізація фактичних даних проекту безпосередньо з автоматизації служби проекту до журналу інтеграції проекту для публікації у фінансах та операціях

[!include[banner](../includes/banner.md)]

У цій статті описано шаблони та базові завдання, які використовуються для синхронізації фактичних даних проекту безпосередньо з Dynamics 365 Project Service Automation Dynamics 365 Finance.
...
[![Інтеграція потоку даних для автоматизації обслуговування проектів з фінансами та операціями.](./media/ProjectActualsFlow.jpg)](./media/ProjectActualsFlow.jpg)
...
У шаблоні фактичних відомостей проекту для виконання таких завдань потрібно використовувати програму Microsoft Power Query для програми Excel.
...
У шаблоні оновлення фактичних відомостей проекту потрібно використовувати Power Query для виконання таких завдань:
