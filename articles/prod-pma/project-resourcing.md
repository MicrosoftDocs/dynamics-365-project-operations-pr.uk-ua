...
description: У цій статті наведено відомості про ресурси проекту.
author: Yowelle
ms.date: 09/01/2020
ms.topic: article
ms.prod: ''
...
У цій статті наведено відомості про ресурси проекту.
...
У наведених далі статтях викладається інформація про завдання, які необхідно виконувати при роботі за проектами з підбору ресурсів.
