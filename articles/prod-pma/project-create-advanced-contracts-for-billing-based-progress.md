...
description: У цій статті пояснюється, як створювати контракти на проект, щоб можна було створювати рахунки-фактури для клієнтів на основі відсотка виконаної роботи.
author: RadhikaRS
ms.date: 03/26/2020
ms.topic: article
ms.prod: ''
...
У цій статті пояснюється, як створити контракти на проект, щоб можна було створювати рахунки-фактури для клієнтів на основі відсотка виконаної роботи. Суми рахунку автоматично розраховуються для бюджетних категорій робіт, які було настроєно для проекту. Час виконання рахунку встановлюється під час узгоджувати сервісного договору проекту з клієнтом.

Виконайте процедури, описані в цій статті, щоб настроїти сервісний договір, пов'язаний проект і правила виставлення рахунків, які обчислюють суми рахунків-фактур для бюджетних категорій робіт, створених для проекту.
