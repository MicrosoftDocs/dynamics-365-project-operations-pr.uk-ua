...
description: У цій статті наведено відомості про надсилання клієнту цінової пропозиції для підтвердження, зміни на основі відгуків, а потім повторне надсилання цінової пропозиції.
author: ruhercul
ms.date: 05/09/2020
ms.topic: article
ms.prod: ''
