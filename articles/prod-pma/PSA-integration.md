...
description: У цьому розділі наведено відомості Dynamics 365 Project Service Automation про рішення для інтеграції Dynamics 365 Finance.
author: ruhercul
ms.date: 07/25/2019
ms.topic: overview
ms.prod: ''
