---
title: Переосмислені звіти про витрати (містить відео)
...
|Швидко деталізуйте повторювані витрати | Переосмислена робоча область витрат надає можливість швидко деталізувати повторювані витрати, додавши підкатегорію, дату початку та кількість. Кількість відноситься до кількості разів, коли заряд повторюється протягом безперервного періоду. |
