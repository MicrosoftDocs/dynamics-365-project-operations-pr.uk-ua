---
title: Звіти про витрати переосмислені (містить відео)
description: У цій статті пояснюється перероблений і переосмислений досвід для запису звіту про витрати.
author: suvaidya
ms.date: 12/16/2021
ms.topic: article
ms.prod: ''
...
|Швидко деталізуйте повторювані витрати | Переосмислена робоча область витрат надає можливість швидко перераховувати повторювані витрати, додаючи підкатегорію, дату початку та кількість. Кількість відноситься до кількості повторювань заряду протягом безперервного періоду. |
