...
description: У цій статті наведено відомості про оптичне розпізнавання символів (OCR) на квитанціях.
author: suvaidya
ms.date: 11/10/2021
ms.topic: article
ms.prod: ''
...
Доступність цієї функції в різних регіонах наведена в таблиці нижче. Якщо регіон наразі не підтримується, надішліть запит щодо визначення пріоритетів доступності служби OCR у вашому регіоні. 
...
| AUS    | Так                               |
| EU     | Частково. Квитанції лише англійською мовою. |
| Азія   | No                                |
| Японія  | No                                |
| Африка | No                                |
