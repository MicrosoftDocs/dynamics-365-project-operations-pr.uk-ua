...
description: У цій статті наведено відомості про мобільну робочу область керування витратами.
author: suvaidya
ms.date: 11/15/2021
ms.topic: article
ms.prod: ''
