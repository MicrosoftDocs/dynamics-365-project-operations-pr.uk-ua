...
description: Ви можете налаштувати політику витрат, якої повинні дотримуватися ваші працівники під час введення та подання звітів про витрати та реквізиції подорожей у Microsoft Dynamics 365 Finance.
author: suvaidya
ms.date: 05/20/2020
ms.topic: article
ms.prod: ''
