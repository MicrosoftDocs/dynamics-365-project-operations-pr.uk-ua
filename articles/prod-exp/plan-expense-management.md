...
description: У цій статті описано міркування та рішення, які необхідно прийняти під Вільний час планування, перш ніж настроїти управління витратами в Microsoft Dynamics 365 фінанси.
author: KimANelson
ms.date: 08/29/2017
ms.topic: article
ms.prod: ''
...
У цій статті описано міркування та рішення, які потрібно прийняти під час процесу планування, перш ніж настроїти керування витратами. В розділі «Керування витратами» можна зберігати інформацію про методи оплати, потреби у подорожах, звіти про витрати, політику тощо.
