...
description: У цій статті пояснюється, як імпортувати та підтримувати операції з кредитними картками, пов'язаними з витратами. Ці транзакції можна настроїти таким чином, щоб вони автоматично імпортувалися за розкладом із певною періодичністю, або їх можна імпортувати вручну за потреби.
author: KimANelson
ms.date: 01/12/2018
ms.topic: article
ms.prod: ''
