...
description: У цій статті пояснюється, як можна використовувати систему робочого процесу в Microsoft Dynamics 365 фінансів, щоб настроїти процес рецензування для звітів про витрати в управлінні витратами.
