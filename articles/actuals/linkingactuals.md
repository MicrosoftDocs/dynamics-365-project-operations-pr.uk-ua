...
description: У цьому розділі пояснюється, як концепція походження транзакцій використовується для зв'язування фактичних відомостей з вихідними записами, такими як запис часу, запис витрат або журнали використання матеріалів.
author: rumant
ms.date: 03/25/2021
ms.topic: article
ms.prod: ''
